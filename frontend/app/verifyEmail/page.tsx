        ...
        <div className="rounded-[20px] border border-gray-100 bg-white p-8 shadow-soft md:p-10">
          <div className="flex flex-col items-center text-center">
            <div className="flex items-center gap-4">
              ...
              <p className="font-playfair-italic text-2xl text-primary md:text-3xl">Verify email</p>
              <span className="h-px w-8 bg-gray-300 md:w-12" />
            </div>
          ...
          <form className="mt-8 space-y-5" onSubmit={handleSubmit}>
            ...
            <p className="text-center text-[14px] text-secondary">
              ...
              <button
                ...
                className="font-semibold text-anthracite hover:underline disabled:opacity-50"
              >
          ...
          <p className="mt-6 text-center text-[14px] text-secondary">
            <Link href="/login" className="font-semibold text-anthracite hover:underline">Back to sign in</Link>
          </p>
        </div>
      </div>
    </div>
